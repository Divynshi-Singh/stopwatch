...
//     if (minutes < 10) minutes = '0' + minutes;
//     if (remainingSeconds < 10) remainingSeconds = '0' + remainingSeconds;
//     if (remainingMilliseconds < 10) remainingMilliseconds = '0' + remainingMilliseconds;  
//     else if (remainingMilliseconds < 10) remainingMilliseconds = '0' + remainingMilliseconds;
